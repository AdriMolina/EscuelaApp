package com.example.adi.escuelaapp.Adapters;
...
import com.example.adi.escuelaapp.R;
...
public class SpinnerUsuariosAdapter extends BaseAdapter {
    List<Usuario>list = new ArrayList<>();
    Context context;
    String nombre;

    public SpinnerUsuariosAdapter(List<Usuario> list, Context context) {
        this.list = list;
